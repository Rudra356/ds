      ...
      <div className="container px-5 my-5">
        <div className="row gx-5">
          ...
          <div className="col-lg-4 mb-5 mb-lg-0">
            ...
            <p>
              Enter your waste type and get instant guidance on proper disposal methods. 
              Our system helps you make eco-friendly choices to reduce waste pollution.
            </p>
          ...
          <div className="col-lg-4 mb-5 mb-lg-0">
            ...
            <p>
              Learn how to dispose of different types of waste safely and responsibly. 
              We provide detailed guidelines to ensure minimal environmental impact.
            </p>
            <a className="text-decoration-none" href="#!">
          ...
          <div className="col-lg-4">
            ...
            <p>
              Discover ways to recycle and upcycle waste materials instead of throwing them away. 
              Help create a sustainable future by reusing and repurposing waste effectively.
            </p>
            <a className="text-decoration-none" href="#!">
